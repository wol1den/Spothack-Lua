...
client.exec("clear")
client.exec("SV_MAXUSRCMDPROCESSTICKS 18")
...
local builderBtn = ui.new_button(tab, container, "Anti-aim", function() 
    vars.currentTab = 2
end)
local visBtn = ui.new_button(tab, container, "\acdffffFFVisuals / Misc\a", function() 
    vars.currentTab = 3
end)
local cfgBtn = ui.new_button(tab, container, "\aConfig\a", function() 
    vars.currentTab = 4
end)
local RageBtn = ui.new_button(tab, container, "\acdffffFFRage\a", function() 
    vars.currentTab = 5
end)
...
local menu = {
    ...
    --    watermarkPosition = ui.new_combobox(tab, container, "\n watermark position", "Left", "Bottom", "Right"),
     ...
     --   newline4 = ui.new_label('LUA', 'B', '\n', 'string'),
        ...
        newline4 = ui.new_label('LUA', 'B', '\n', 'string'),
        newline41 = ui.new_label('LUA', 'B', '\n', 'string'),
        newline42 = ui.new_label('LUA', 'B', '\n', 'string'),
        newline43 = ui.new_label('LUA', 'B', '\n', 'string'),
        newline44 = ui.new_label('LUA', 'B', '\n', 'string'),
        newline45 = ui.new_label('LUA', 'B', '\n', 'string'),
        newline46 = ui.new_label('LUA', 'B', '\n', 'string'),
        newline47 = ui.new_label('LUA', 'B', '\n', 'string'),
        newline48 = ui.new_label('LUA', 'B', '\n', 'string'),
        newline49 = ui.new_label('LUA', 'B', '\n', 'string'),
        newline50 = ui.new_label('LUA', 'B', '\n', 'string'),
        newline51 = ui.new_label('LUA', 'B', '\n', 'string'),
        newline52 = ui.new_label('LUA', 'B', '\n', 'string'),
        newline53 = ui.new_label('LUA', 'B', '\n', 'string'),
        newline54 = ui.new_label('LUA', 'B', '\n', 'string'),
        newline55 = ui.new_label('LUA', 'B', '\n', 'string'),
        newline56 = ui.new_label('LUA', 'B', '\n', 'string'),
        newline57 = ui.new_label('LUA', 'B', '\n', 'string'),
        newline58 = ui.new_label('LUA', 'B', '\n', 'string'),
    },
    configTab = {
...
for i=1, #vars.aaStates do
    ...
    aaBuilder[i] = {
        ...
        newline20 = ui.new_label('LUA', 'B', '\n', 'string'),
        newline21 = ui.new_label('LUA', 'B', '\n', 'string'),
        newline22 = ui.new_label('LUA', 'B', '\n', 'string'),
    }
end
...
local function clantag_set()
    ...
    if func.includes(ui.get(menu.visualsTab.MiscMultiselect), "Clantag") then
        ...
        if entity.get_prop(entity.get_game_rules(), "m_gamePhase") == 5 then
            clan_tag = clantag_anim('#Spothack.LUA', {13})
...
client.set_event_callback("paint", function()
  ...
  --[[  local watermarkClr = {}
    ...
    if readfile("7b2b96286f1c43b7968eca08c6495680f1fe0046_full.jpg") ~= nil and ui.get(menu.visualsTab.watermark) == "Old" then
        local mainY = 4
        local marginX, marginY = renderer.measure_text("-d", lua_name:upper())
        local png = images.load_jpg(readfile("7b2b96286f1c43b7968eca08c6495680f1fe0046_full.jpg"))
    ...
    if readfile("7b2b96286f1c43b7968eca08c6495680f1fe0046_full.jpg") ~= nil and ui.get(menu.visualsTab.hud) == "v1" and func.includes(ui.get(menu.visualsTab.VisualsMultiselect), "Spothack menu") then
        local png = images.load_jpg(readfile("7b2b96286f1c43b7968eca08c6495680f1fe0046_full.jpg"))
        png:draw(ui.get(menu.visualsTab.hudX), ui.get(menu.visualsTab.hudY), 267, 172)
    end

    if readfile("7b2b96286f1c43b7968eca08c6495680f1fe0046_full.jpg") ~= nil and ui.get(menu.visualsTab.hud) == "v2" and func.includes(ui.get(menu.visualsTab.VisualsMultiselect), "Spothack menu") then
        local png = images.load_jpg(readfile("7b2b96286f1c43b7968eca08c6495680f1fe0046_full.jpg"))
...
local jpgsoufiw = images.load_jpg(readfile("_wmUXLKY4blRo7JPbNzIZQyF7-UVi8PxdxZAixwYDYUUN6tvDeUmYRHxS4rNxCS_rXRWrS_GlF7mBuNJJzEkwbfo.jpg"))
...
function visual_functions:intspot()
    ...
    for i = 1,#intro do
     ...
     --   jpgsoufiw:draw(w / 2.15, h / 2.3)
      --  jpg:draw(w / 2.15, h / 2.3,101,130,190,intro[i].alpha)
